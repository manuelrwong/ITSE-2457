 ...
 * @version 1.0
 */
public class DogPanelWithListenerAsInnerClass extends JPanel {
	...
	public DogPanelWithListenerAsInnerClass(){
	    ...
	    this.create.addActionListener(new DogActionListener());
	 ...
	 * @version 1.0
	 */
	private class DogActionListener implements ActionListener{
		/**
