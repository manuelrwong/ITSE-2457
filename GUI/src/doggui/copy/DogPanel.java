...
public class DogPanel extends JPanel {
	...
	public DogPanel(){
	    ...
	    this.create.addActionListener(new DogActionListener(this));
	...
	/**
	 * Returns a reference to the name text filed of this panel. 
	 * @return A reference to the name text filed of this panel
	 */
	...
	/**
	 * Returns a reference to the type combo box of this panel.
	 * @return A reference to the type combo box of this panel
	 */
	...
	/**
	 * Returns a reference to the text area of this panel.
	 * @return A reference to the text area of this panel
	 */
   ...
   /**
    * Returns a reference to create button of this panel.
    * @return A reference to  create button of this panel
    */
